                            ...
                            <Card>
                                ...
                                <Card.Body>
                                    ...
                                    <div className="card-buttons">
                                        <Button className="card-btn view-btn" onClick={() => navigate(`/view/${product.id}`)}><FaEye /></Button>

                                        <Button variant="success" className="card-btn edit-btn" onClick={() => navigate(`/edit/${product.id}`)}><FaPenToSquare /></Button>

                                        <Button onClick={() => dispatch(deleteProductAsync(product.id))} className=" card-btn delete-btn ms-2" variant="danger"><FaTrash /></Button>
